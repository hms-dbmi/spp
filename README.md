...
Note: if Boost libraries are installed in non-standard location, please specify the location in a BOOST\_ROOT environment variable prior to running the installation.
```
